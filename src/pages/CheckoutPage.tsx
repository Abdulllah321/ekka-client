                      ...
                      <div className="ec-sb-block-content">
                        <div className="ec-check-pay-img-inner">
                          <div className="ec-check-pay-img">
                            <img
                              src="assets/images/icons/payment1.png"
                              alt=""
                            />
                          </div>
                          <div className="ec-check-pay-img">
                            <img
                              src="assets/images/icons/payment2.png"
                              alt=""
                            />
                          </div>
                          <div className="ec-check-pay-img">
                            <img
                              src="assets/images/icons/payment3.png"
                              alt=""
                            />
                          </div>
                          <div className="ec-check-pay-img">
                            <img
                              src="assets/images/icons/payment4.png"
                              alt=""
                            />
                          </div>
                          <div className="ec-check-pay-img">
                            <img
                              src="assets/images/icons/payment5.png"
                              alt=""
                            />
                          </div>
                          <div className="ec-check-pay-img">
                            <img
                              src="assets/images/icons/payment6.png"
                              alt=""
                            />
                          </div>
                          <div className="ec-check-pay-img">
                            <img
                              src="assets/images/icons/payment7.png"
                              alt=""
                            />
                          </div>
                        </div>
