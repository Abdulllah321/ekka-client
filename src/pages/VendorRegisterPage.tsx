...
const RegisterPage: React.FC = () => {
  ...
  if (isAuthenticated) {
    return <Navigate to="/upgrade-to-vendor" />;
  }
  return (
    <Layout>
            ...
            <div className="col-12">
              <div className="row ec_breadcrumb_inner">
                <div className="col-md-6 col-sm-12">
                  <h2 className="ec-breadcrumb-title">Vendor Register</h2>
                </div>
                <div className="col-md-6 col-sm-12">
          ...
          <div className="row">
            <div className="col-md-12 text-center">
              <div className="section-title">
                <h2 className="ec-bg-title">Vendor Register</h2>
                <h2 className="ec-title">Vendor Register</h2>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <span className="ec-register-wrap ec-register-btn">
                      <button className="btn btn-primary w-100" type="submit">
                        {isLoading ? <DotLoader /> : "Vendor Register"}
                      </button>
                    </span>
                  </form>{" "}
