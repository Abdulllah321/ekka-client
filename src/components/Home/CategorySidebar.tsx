...
const CategorySidebar = () => {
  return (
    <>
      <div className="ec-side-cat-overlay" />
              ...
              <div className="ec-sidebar-block">
                <div className="ec-sb-title">
                  <h3 className="ec-sidebar-title">
                    Category<button className="ec-close">×</button>
                  </h3>
                </div>
                  ...
                  <ul>
                    <li>
                      <div className="ec-sidebar-block-item">
                        <img
                          src="assets/images/icons/dress-8.png"
                          className="svg_img"
                          alt="drink"
                        />
                        Cothes
                        ...
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              Shirt <span title="Available Stock">- 25</span>
                            </a>
                          </div>
                        </li>
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              shorts &amp; jeans{" "}
                              <span title="Available Stock">- 52</span>
                            </a>
                          </div>
                        </li>
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              jacket<span title="Available Stock">- 500</span>
                            </a>
                          </div>
                        </li>
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              dress &amp; frock{" "}
                              <span title="Available Stock">- 35</span>
                            </a>
                          </div>
                        </li>
                      </ul>
                ...
                <div className="ec-sb-block-content">
                  <ul>
                    <li>
                      <div className="ec-sidebar-block-item">
                        <img
                          src="assets/images/icons/shoes-8.png"
                          className="svg_img"
                          alt="drink"
                        />
                        Footwear
                      ...
                      <ul>
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              Sports <span title="Available Stock">- 25</span>
                            </a>
                          </div>
                        </li>
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              Formal <span title="Available Stock">- 52</span>
                            </a>
                          </div>
                        </li>
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              Casual <span title="Available Stock">- 40</span>
                            </a>
                          </div>
                        </li>
                        <li>
                ...
                <div className="ec-sb-block-content">
                  <ul>
                    <li>
                      <div className="ec-sidebar-block-item">
                        <img
                          src="assets/images/icons/jewelry-8.png"
                          className="svg_img"
                          alt="drink"
                        />
                        jewelry
                      ...
                      <ul>
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              Earrings <span title="Available Stock">- 50</span>
                            </a>
                          </div>
                        </li>
                        <li>
                        ...
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              Necklace <span title="Available Stock">- 40</span>
                            </a>
                          </div>
                        </li>
                      </ul>
                ...
                <div className="ec-sb-block-content">
                  <ul>
                    <li>
                      <div className="ec-sidebar-block-item">
                        <img
                          src="assets/images/icons/perfume-8.png"
                          className="svg_img"
                          alt="drink"
                        />
                        perfume
                      ...
                      <ul>
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              Clothes perfume
                              <span title="Available Stock">- 4 pcs</span>
                            </a>
                          </div>
                        </li>
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              deodorant{" "}
                              <span title="Available Stock">- 52 pcs</span>
                            </a>
                          </div>
                        </li>
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              Flower fragrance{" "}
                              <span title="Available Stock">- 10 pack</span>
                            </a>
                          </div>
                        </li>
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              Air Freshener
                              <span title="Available Stock">- 35 pack</span>
                            </a>
                          </div>
                        </li>
                      </ul>
                ...
                <div className="ec-sb-block-content">
                  <ul>
                    <li>
                      <div className="ec-sidebar-block-item">
                        <img
                          src="assets/images/icons/cosmetics-8.png"
                          className="svg_img"
                          alt="drink"
                        />
                        cosmetics
                ...
                <div className="ec-sb-block-content">
                  <ul>
                    <li>
                      <div className="ec-sidebar-block-item">
                        <img
                          src="assets/images/icons/glasses-8.png"
                          className="svg_img"
                          alt="drink"
                        />
                        glasses
                      ...
                      <ul>
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              Sunglasses{" "}
                              <span title="Available Stock">- 20</span>
                            </a>
                          </div>
                        </li>
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              Lenses <span title="Available Stock">- 52</span>
                            </a>
                          </div>
                        </li>
                      </ul>
                ...
                <div className="ec-sb-block-content">
                  <ul>
                    <li>
                      <div className="ec-sidebar-block-item">
                        <img
                          src="assets/images/icons/bag-8.png"
                          className="svg_img"
                          alt="drink"
                        />
                        bags
                      ...
                      <ul>
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              shopping bag{" "}
                              <span title="Available Stock">- 25</span>
                            </a>
                          </div>
                        </li>
                        <li>
                        ...
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              purse <span title="Available Stock">- 40</span>
                            </a>
                          </div>
                        </li>
                        <li>
                          <div className="ec-sidebar-sub-item">
                            <a href="shop-left-sidebar-col-3.html">
                              wallet <span title="Available Stock">- 35</span>
                            </a>
                          </div>
                        </li>
                      </ul>
